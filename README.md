...
<p align="center">
<sub><sup><strike>Initially I wanted to create a game whereby the user shoots out letters from a sentence. It starts off with a gameplay that would display a peaceful city. Secondly, a sudden attack by an alien invasion and the user need to save the city and citizens from attacks above using sentences that would appear promptly on the screen. The user then type the word in and it shoots off the letters as a projectile to hit the alien spaceship above!</strike></sub></sup>
</p>
